...
import { updateStart, updateSuccess, updateFailure, deleteUserStart, deleteUserSuccess, deleteUserFailer, signoutSucces } from "../redux/user/userSlice.js"
  ...
  return (
    <div className="max-w-lg mx-auto p-3 w-full">
      ...
      <form onSubmit={handleSubmit} className="flex flex-col gap-4">
        <input type="file" accept="image/*" onChange={handleImageChanged} ref={filePickerRef} hidden/>
